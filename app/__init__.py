...
def create_app():
    ...
    from app.models import TerritoryUnit, PositionType, Person, Recipient, RecipientAdmin, PersonAdmin, ContractType, FormFields, PersonJson
    ...
    admin.add_view(RecipientAdmin(PersonJson, db.session))
